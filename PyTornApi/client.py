...
from .exceptions import WrongReturnError
...
class TornAPI:
    """Creates a TornAPI object (or whatever). First argument is your API key. Second argument is the user agent for requests (so cloudflare doesnt block).\n
    ...
    def _call(self, endpoint, params=None):
        ...
        try:
            ...
            raise WrongReturnError('Torn API didnt respond with JSON. Likely caused by getting blocked by Cloudflare.')
    ...
    def get_property(self, property_id: int, selections: PropertyField | str | None = None):
        """Gets a property from a property ID.
        Available selections:
        lookup, property, timestamp"""
        params = {"selections": selections} if selections else {}
        return self._call(f"property/{property_id}", params)
    def get_faction(self, faction_id: int, selections: FactionField | str | None = None):
    ...
    def get_company(self, company_id: int, selections: CompanyField | str | None = None):
    ...
    def get_market(self, market_id: int, selections: MarketField | str | None = None):
    ...
    def get_torn(self, torn_id: int, selections: TornField | str | None = None):
